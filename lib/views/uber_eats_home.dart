...
class UberEatsHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categories = [
      {'name': '生鮮雜貨', 'icon': Icons.local_grocery_store},
      {'name': '珍珠奶茶', 'icon': Icons.local_cafe},
      {'name': '披薩', 'icon': Icons.local_pizza},
      {'name': '健康飲食', 'icon': Icons.health_and_safety},
      {'name': '便利食品', 'icon': Icons.fastfood},
      {'name': '生鮮雜貨', 'icon': Icons.local_grocery_store},
      {'name': '珍珠奶茶', 'icon': Icons.local_cafe},
      {'name': '披薩', 'icon': Icons.local_pizza},
      {'name': '健康飲食', 'icon': Icons.health_and_safety},
